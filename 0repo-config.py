...
REPOSITORY_BASE_URL = "https://apps.chyla.org/"
...
GPG_SIGNING_KEY = None if os.getenv('NO_SIGN') else "0x09C6348C6917D7CDCD74041B53984B48D35B4B7B"
...
def upload_public_dir(files, message):
	...
	input("Press Return when done (edit 0repo-config.py:upload_public_dir() to automate this)")
	...
	if 0:
		...
		if changed:
			input("Press Return to commit and push the above changes. CTRL-C to abort.")
